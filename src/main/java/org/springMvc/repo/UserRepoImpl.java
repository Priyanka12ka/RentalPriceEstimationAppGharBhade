...
public class UserRepoImpl implements UserRepo{
	...
	public int save(User user) {
		...
		return jdbcTemplate.update("insert into users(username,email,contact,password) values(?,?,?,?)",
	...
	public List<User> display() {
		...
		List<User> list = jdbcTemplate.query("select * from users where role='USER'", new RowMapper<User>() {
	...
	public List<User> search(int id) {
		...
		List<User> list = jdbcTemplate.query("select * from users where id=?", new RowMapper<User>() {
